...
Type
    TArrSctNms = Array[0..1] Of String;
Const
     SectionsValueNames:TArrSctNms=('Valor Bruto del Acta','Total descuentos');
     SectionsTitles:TArrSctNms=('','DESCUENTOS');
{ Error Messages }
...
Const
     ...
     ME_035 = 'AE035: Inesperado error interno. No coinciden los categorías '+
              ...
              'a soporte técnico.';
     ME_036 = 'AE036: No pudo grabar los datos. Error técnico : %s';
     ...
     ME_177 = 'AE177: Registro no existe o no está vigente en la tabla %s';
...
Const
     SQLCommonSelection01 = 'Select A.PORTION_NO,A.ACT_PAID_DATE,A.APPROVED_BY,%s '+
                            'FROM SAF3A0 A,MSF384 C';
     SQLCommonSelection02 = ',MSF385 D';
...
Const
     SQLSuppliers01 = 'Select SUPPLIER_NO,SUPPLIER_NAME From MSF200';
...
Const
     ...
     SQL_Pendents04 = 'From SAF3A0 A,MSF384 B';
     SQL_Pendents05 = 'Where (A.CONTRACT_NO in (Select CONTRACT_NO From MSF385';
...
Const
     ...
     SQLRep0204 = 'From MSF387 A,MSF010 B';
...
Const
     ...
     MI_024 = 'Valor editado del Elemento : %m';
