...
begin
     ...
     Try
        ...
        //Try
           ...
           //dbActPaid.Params.Values['USER NAME'] := 'saqusr';
           //dbActPaid.Params.Values['PASSWORD']  := 'actas2015';
        //Except
        //   On E: Exception do begin
        //       Application.Terminate;
        //   end;
...
begin
     ...
     hardcode y luego como parametro}
        If tblInfoAtaxATAX_BASE.AsCurrency - ActPaidNewNetValue > 25000 Then Begin
